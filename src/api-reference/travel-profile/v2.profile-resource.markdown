...
```shell
GET {InstanceURI}/api/travelprofile/v2.0/summary?LastModifiedDate=2020-01-01T01:00:00&travelConfigs=100,200,3000&isActive=1 HTTP/1.1
Authorization: OAuth {access token}
```
...
`isActive`|Optional|` xx` | Active status of the user. 1 = Active users. 0 = Inactive users. Leaving it off will return all users
